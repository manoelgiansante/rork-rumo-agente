...
enum Config {
    ...
    static let EXPO_PUBLIC_CLAUDE_API_KEY = "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"
    static let EXPO_PUBLIC_AGENT_BACKEND_URL = "http://216.238.111.253"
}
